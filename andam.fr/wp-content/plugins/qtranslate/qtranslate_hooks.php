...
function qtrans_localeForCurrentLanguage($locale){
   ...
   if (isset($q_config['language']) && !empty($q_config['language'])) {
...
// hack pour affiche la trad dispo //
add_filter('the_posts',						'qtrans_useCurrentLanguageIfNotFoundUseDefaultLanguage', 0);  
