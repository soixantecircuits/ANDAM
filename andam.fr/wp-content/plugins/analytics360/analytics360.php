...
function a360_request_handler() {
	if (!empty($_GET['a360_action']) && current_user_can('moderate_comments')) {
	...
	if (!empty($_POST['a360_action']) && current_user_can('moderate_comments')) {
...
// hack mick permet aux utilisateurs en mode editeur de voir analytic360 //
